...
Key Observations:
Casual Riders: Classic bikes have the longest average ride time (14.4 minutes).
Electric bikes follow at 11.4 minutes, and electric scooters are at 9.5 minutes.
Members: Classic bikes again have the longest average ride time (10.8 minutes).
Electric bikes have a similar duration (9.5 minutes), and scooters are the shortest at 7.4 minutes.
...
Insights: Casual riders are more active on weekends, likely for leisure and recreational purposes.
...
Insights: Members primarily use the service during weekdays, indicating commuting or routine trips.

5. Average rides per month

![image](https://github.com/user-attachments/assets/2b8a837d-fc07-4103-a1d1-7b5b18aaf673)
Casual riders peak during the summer months: July (16.0K), August (15.8K), and September (15.5K).
Minimal activity during the winter months: January (1.4K) and February (2.8K).

Insights: Casual riders are heavily influenced by seasonal trends, favoring warm weather for recreational use.
...
Insights:
Members maintain consistent use throughout the year, with peaks in warmer months likely tied to both commuting and leisure activities. Even during low-activity months, members display higher engagement compared to casual riders.
...
Casual Riders (Blue Line): Higher activity peaks during late morning and afternoon hours on weekends (e.g., 10 AM to 4 PM), reflecting recreational or leisure use.
Minimal activity during weekday commuting hours (e.g., early morning and late afternoon).

Members (Orange Line):
Consistent peaks during weekday commuting hours, with sharp increases around 8 AM and 5 PM.
Lower activity during weekends compared to casual riders, indicating a focus on commuting rather than leisure.

Insights: Members show predictable, work-oriented ride patterns, while casual riders are driven by leisure usage on weekends.
...
Casual riders tend to favor routes near iconic landmarks and recreational areas.
...
Members heavily use routes near educational or institutional areas, suggesting commuting purposes.
...
- Common high-traffic routes exist, such as those in central city locations and popular tourist spots.

Differences:
- Ride Frequency: Members ride more frequently (18 rides/month) compared to casual riders (3 rides/month).
